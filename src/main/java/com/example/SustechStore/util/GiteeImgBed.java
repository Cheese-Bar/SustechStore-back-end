...
public class GiteeImgBed {
    ...
    //码云私人令牌，需要补充
    public static final String ACCESS_TOKEN = "3b5a255958d3c83723dd191c51d247d7";
    //个人空间名，需要补充
    public static final String OWNER = "cheesrbar";
    //仓库名，需要补充
    public static final String REPO_NAME = "sustech-store";
    //文件夹路径
